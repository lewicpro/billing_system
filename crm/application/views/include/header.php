...
<head>
    ...
    <link rel="icon"
          href="<?php echo base_url((setting_all('favicon')) ? 'assets/images/' . setting_all('favicon') : 'assets/images/favicon.ico'); ?>">
    <title>Neo CRM</title>
...
<body class="hold-transition skin-blue-light sidebar-mini" data-base-url="<?php echo base_url(); ?>">
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?php echo base_url(); ?>" class="logo">
            ...
            <span class="logo-mini">NEO</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">Aleco Tanzania</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?php echo base_url() . 'assets/images/' . $profile_pic; ?>" class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu" role="menu" style="width: 164px;">
                            <li><a href="<?php echo base_url('user/profile'); ?>"><i class="fa fa-user mr10"></i>My
                                    Account</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo base_url('user/logout'); ?>"><i class="fa fa-power-off mr10"></i>
                                    Sign Out</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="<?= ($this->router->method === "profile") ? "active" : "not-active" ?>">
                    <a href="<?php echo base_url('user/profile'); ?>"> <i class="fa fa-user"></i> <span>Home</span></a>
                </li>
                <?php $this->load->view("include/menu"); ?>


                <li class="<?= ($this->router->class === "invoice") ? "active" : "not-active" ?>">
                    <a href="<?php echo base_url("invoices"); ?>"><i class="fa fa-list-alt"></i>
                        <span>Invoices</span></a>
                </li>

                <li class="<?= ($this->router->class === "payments") ? "active" : "not-active" ?>">
                    <a href="<?php echo base_url("payments"); ?>"><i class="fa fa-list-alt"></i>
